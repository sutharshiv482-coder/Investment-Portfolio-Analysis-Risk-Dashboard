...
| KPI | Description |
|------|-------------|
| 💰 Total Portfolio Value | Current value of portfolio holdings |
| 📈 Total Portfolio Return (%) | Overall return generated by the portfolio |
| 💹 Unrealised Profit & Loss | Current unrealised gain or loss across holdings |
| 📊 Portfolio Volatility | Measure of portfolio return variability |
| ⚖️ Sharpe Ratio | Risk-adjusted return relative to volatility |
| ⚠️ Value at Risk (VaR) | Estimated potential loss at a selected confidence level |
| 📉 Maximum Drawdown | Maximum decline from a portfolio peak |
| 🎯 Portfolio Beta | Portfolio sensitivity to market movements |
| 🏦 Sector Allocation | Portfolio exposure across sectors |
| 💵 Dividend Income | Dividend contribution generated by holdings |
